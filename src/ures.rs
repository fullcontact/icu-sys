...
extern "C" {
    pub fn ures_open(packageName: *const ::libc::c_char,
                     locale: *const ::libc::c_char, status: *mut UErrorCode)
     -> *mut UResourceBundle;
    pub fn ures_openDirect(packageName: *const ::libc::c_char,
    ...
    pub fn ures_getUTF8String(resB: *const UResourceBundle,
                              dest: *mut ::libc::c_char, length: *mut int32_t,
                              forceCopy: UBool, status: *mut UErrorCode)
     -> *const ::libc::c_char;
    ...
    pub fn ures_getStringByKey(resB: *const UResourceBundle,
                               key: *const ::libc::c_char, len: *mut int32_t,
                               status: *mut UErrorCode) -> *const UChar;
    pub fn ures_getUTF8StringByKey(resB: *const UResourceBundle,
                                   ...
                                   status: *mut UErrorCode)
     -> *const ::libc::c_char;
    pub fn ures_openAvailableLocales(packageName: *const ::libc::c_char,
                                     status: *mut UErrorCode)
     -> *mut UEnumeration;
}
